...
expression <- c("is.na(INN$ENTGRP_PART) == FALSE & INN$ENTGRP_PART == 1", 
                "is.na(INN$ENTGRP_HD_NAT) == FALSE & INN$ENTGRP_HD_NAT == 1", 
                "is.na(INN$ENTGRP_HD_FOR) == FALSE & INN$ENTGRP_HD_FOR == 1",
                "is.na(INN$ENTGRP_ENT_EG_NAT) == FALSE & INN$ENTGRP_ENT_EG_NAT == 1")

expression2 <- c("ENTGRP_PART", 
                 "ENTGRP_HD_NAT", 
                 "ENTGRP_HD_FOR",
                 "ENTGRP_ENT_EG_NAT")
...
expression <- c("is.na(NINN$ENTGRP_PART) == FALSE & NINN$ENTGRP_PART == 1", 
                "is.na(NINN$ENTGRP_HD_NAT) == FALSE & NINN$ENTGRP_HD_NAT == 1", 
                "is.na(NINN$ENTGRP_HD_FOR) == FALSE & NINN$ENTGRP_HD_FOR == 1",
                "is.na(NINN$ENTGRP_ENT_EG_NAT) == FALSE & NINN$ENTGRP_ENT_EG_NAT == 1")
...
result_T25_DT <- rbind(Aggregate_INN, Aggregate_NINN)
result_T25_DT %>% group_by(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_EMPL, INN_PF, INDICATOR, CIS_INDICATOR, UNIT_MEASURE, UNIT_MULT, DECIMALS) %>% summarise(OBS_VALUE = sum(OBS_VALUE)) -> result_T25_DT
# result_T25_DT <- result_T25_DT[, .(SUM_OBS_VALUE=sum(OBS_VALUE)), by = "DATAFLOW,FREQ,TIME_PERIOD,REF_AREA,TABLENAME,ACTIVITY,NUMBER_EMPL,INN_PF,INDICATOR,CIS_INDICATOR,UNIT_MEASURE,UNIT_MULT,DECIMALS"]
colnames(result_T25_DT)[14] <- "OBS_VALUE"

result_T25_DT_FINAL <- cbind(result_T25_DT[, 1:7], stringsAsFactors = FALSE)
result_T25_DT_FINAL$TYPE_ENT <- "_T"
result_T25_DT_FINAL <- cbind(result_T25_DT_FINAL, result_T25_DT[, c(8:10, 14, 11:13)], stringsAsFactors = FALSE)
result_T25_DT_FINAL$OBS_STATUS <- ""
result_T25_DT_FINAL$OBS_STATUS_1 <- ""
result_T25_DT_FINAL$CONF_STATUS <- ""
result_T25_DT_FINAL$COMMENT_OBS <- ""
result_T25_DT_FINAL <- as.data.frame(result_T25_DT_FINAL)
result_T25_DT_FINAL$OBS_VALUE <- as.character(result_T25_DT_FINAL$OBS_VALUE)
result_T25_DT_FINAL[, "OBS_VALUE"] <- gsub("\\.", ",", result_T25_DT_FINAL[, "OBS_VALUE"])

result_T25_DT_FINAL[result_T25_DT_FINAL$ACTIVITY == "A" | result_T25_DT_FINAL$ACTIVITY == "A01" | result_T25_DT_FINAL$ACTIVITY == "A02" | result_T25_DT_FINAL$ACTIVITY == "A03" | result_T25_DT_FINAL$ACTIVITY == "F" | result_T25_DT_FINAL$ACTIVITY == "G45" | result_T25_DT_FINAL$ACTIVITY == "G47" | result_T25_DT_FINAL$ACTIVITY == "I" | result_T25_DT_FINAL$ACTIVITY == "L" | result_T25_DT_FINAL$ACTIVITY == "M69" | result_T25_DT_FINAL$ACTIVITY == "M70" | result_T25_DT_FINAL$ACTIVITY == "M74" | result_T25_DT_FINAL$ACTIVITY == "M75" | result_T25_DT_FINAL$ACTIVITY == "N" | result_T25_DT_FINAL$ACTIVITY == "N77" | result_T25_DT_FINAL$ACTIVITY == "N78" | result_T25_DT_FINAL$ACTIVITY == "N79" | result_T25_DT_FINAL$ACTIVITY == "N80" | result_T25_DT_FINAL$ACTIVITY == "N81" | result_T25_DT_FINAL$ACTIVITY == "N82", "OBS_VALUE"] <- ""
result_T25_DT_FINAL <- subset(result_T25_DT_FINAL, ACTIVITY != "GTN" | (ACTIVITY == "GTN" & (NUMBER_EMPL == "_T")))
# result_T25_DT_FINAL <- subset(result_T25_DT_FINAL, ACTIVITY != "G" & ACTIVITY != "M")

result_T25_DT_FINAL <- subset(result_T25_DT_FINAL, TYPE_ENT == "_T")
...
result_T25_DT_FINAL[result_T25_DT_FINAL$ACTIVITY == "G" | result_T25_DT_FINAL$ACTIVITY == "M", "OBS_VALUE"] <- ""
...
write.table(rbind(result_T25_DT_FINAL, Aggregate_INN, Aggregate_NINN), T25_SDMX_FINAL_RESULT, sep = ";", quote = FALSE, row.names = FALSE, append = FALSE)

set_ENT_Profile("as.numeric(ENTGRP_ENT_EG_NAT)", "T25", T25_SDMX_FINAL_RESULT)
set_ENT_Profile("as.numeric(ENTGRP_HD_FOR)", "T25", T25_SDMX_FINAL_RESULT)
set_ENT_Profile("as.numeric(ENTGRP_HD_NAT)", "T25", T25_SDMX_FINAL_RESULT)
set_ENT_Profile("as.numeric(ENTGRP_PART)", "T25", T25_SDMX_FINAL_RESULT)