  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(1)], na.rm = TRUE))
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(2)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(3)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(4)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(5:6)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(5)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(6)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(7:8)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(7)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(8)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(9:10)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(9)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_TOVT[profile_rows[i + ((j - 1) * 4)], c(10)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
