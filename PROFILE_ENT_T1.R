set_ENT_T1_Profile <- function(column_name, tablename_Profile, save_filename){
  
  PROFILE_I_A <<- PROFILE_I_A %>% mutate(SULYOZOTT_ENT_T1 = VGMA001_SULY) 
  PROFILE_I_B <<- PROFILE_I_B %>% mutate(SULYOZOTT_ENT_T1 = VGMA001_SULY)
  PROFILE_II_A <<- PROFILE_II_A %>% mutate(SULYOZOTT_ENT_T1 = VGMA001_SULY) 
  PROFILE_II_B <<- PROFILE_II_B %>% mutate(SULYOZOTT_ENT_T1 = VGMA001_SULY)
  PROFILE_III_A <<- PROFILE_III_A %>% mutate(SULYOZOTT_ENT_T1 = VGMA001_SULY) 
  PROFILE_III_B <<- PROFILE_III_B %>% mutate(SULYOZOTT_ENT_T1 = VGMA001_SULY)
  PROFILE_IV_A <<- PROFILE_IV_A %>% mutate(SULYOZOTT_ENT_T1 = VGMA001_SULY) 
  PROFILE_IV_B <<- PROFILE_IV_B %>% mutate(SULYOZOTT_ENT_T1 = VGMA001_SULY)
  PROFILE_V_A <<- PROFILE_V_A %>% mutate(SULYOZOTT_ENT_T1 = VGMA001_SULY) 
    ...
    for(row in 1:length(filter_M065_RETEG1)){
      ...
      if (col == 1){
        ...
        if (row != 4){
          ...
          Profile_ENT_T1[row, col] <<- sum(subset(PROFILE_I_A, eval(parse(text = filter_M065_RETEG1[row])), SULYOZOTT_ENT_T1), na.rm = TRUE)
          
        }else{
          
          Profile_ENT_T1[row, col] <<- sum(PROFILE_I_A[, "SULYOZOTT_ENT_T1"], na.rm = TRUE)
      ...
      if (col == 2){
        ...
        if (row != 4){
          ...
          Profile_ENT_T1[row, col] <<- sum(subset(PROFILE_I_B, eval(parse(text = filter_M065_RETEG1[row])), SULYOZOTT_ENT_T1), na.rm = TRUE)
          
        }else{
          
          Profile_ENT_T1[row, col] <<- sum(PROFILE_I_B[, "SULYOZOTT_ENT_T1"], na.rm = TRUE)
      ...
      if (col == 3){
        ...
        if (row != 4){
          ...
          Profile_ENT_T1[row, col] <<- sum(subset(PROFILE_II_A, eval(parse(text = filter_M065_RETEG1[row])), SULYOZOTT_ENT_T1), na.rm = TRUE)
          
        }else{
          
          Profile_ENT_T1[row, col] <<- sum(PROFILE_II_A[, "SULYOZOTT_ENT_T1"], na.rm = TRUE)
      ...
      if (col == 4){
        ...
        if (row != 4){
          ...
          Profile_ENT_T1[row, col] <<- sum(subset(PROFILE_II_B, eval(parse(text = filter_M065_RETEG1[row])), SULYOZOTT_ENT_T1), na.rm = TRUE)
          
        }else{
          
          Profile_ENT_T1[row, col] <<- sum(PROFILE_II_B[, "SULYOZOTT_ENT_T1"], na.rm = TRUE)
      ...
      if (col == 5){
        ...
        if (row != 4){
          ...
          Profile_ENT_T1[row, col] <<- sum(subset(PROFILE_III_A, eval(parse(text = filter_M065_RETEG1[row])), SULYOZOTT_ENT_T1), na.rm = TRUE)
          
        }else{
          
          Profile_ENT_T1[row, col] <<- sum(PROFILE_III_A[, "SULYOZOTT_ENT_T1"], na.rm = TRUE)
      ...
      if (col == 6){
        ...
        if (row != 4){
          ...
          Profile_ENT_T1[row, col] <<- sum(subset(PROFILE_III_B, eval(parse(text = filter_M065_RETEG1[row])), SULYOZOTT_ENT_T1), na.rm = TRUE)
          
        }else{
          
          Profile_ENT_T1[row, col] <<- sum(PROFILE_III_B[, "SULYOZOTT_ENT_T1"], na.rm = TRUE)
      ...
      if (col == 7){
        ...
        if (row != 4){
          ...
          Profile_ENT_T1[row, col] <<- sum(subset(PROFILE_IV_A, eval(parse(text = filter_M065_RETEG1[row])), SULYOZOTT_ENT_T1), na.rm = TRUE)
          
        }else{
          
          Profile_ENT_T1[row, col] <<- sum(PROFILE_IV_A[, "SULYOZOTT_ENT_T1"], na.rm = TRUE)
      ...
      if (col == 8){
        ...
        if (row != 4){
          ...
          Profile_ENT_T1[row, col] <<- sum(subset(PROFILE_IV_B, eval(parse(text = filter_M065_RETEG1[row])), SULYOZOTT_ENT_T1), na.rm = TRUE)
          
        }else{
          
          Profile_ENT_T1[row, col] <<- sum(PROFILE_IV_B[, "SULYOZOTT_ENT_T1"], na.rm = TRUE)
      ...
      if (col == 9){
        ...
        if (row != 4){
          ...
          Profile_ENT_T1[row, col] <<- sum(subset(PROFILE_V_A, eval(parse(text = filter_M065_RETEG1[row])), SULYOZOTT_ENT_T1), na.rm = TRUE)
          
        }else{
          
          Profile_ENT_T1[row, col] <<- sum(PROFILE_V_A[, "SULYOZOTT_ENT_T1"], na.rm = TRUE)
      ...
      if (col == 10){
        ...
        if (row != 4){
          ...
          Profile_ENT_T1[row, col] <<- sum(subset(PROFILE_V_B, eval(parse(text = filter_M065_RETEG1[row])), SULYOZOTT_ENT_T1), na.rm = TRUE)
          
        }else{
          
          Profile_ENT_T1[row, col] <<- sum(PROFILE_V_B[, "SULYOZOTT_ENT_T1"], na.rm = TRUE)
      ...
      if (col == 11){
        ...
        if (row != 4){
          ...
          Profile_ENT_T1[row, col] <<- sum(subset(PROFILE_VI, eval(parse(text = filter_M065_RETEG1[row])), SULYOZOTT_ENT_T1), na.rm = TRUE)
          
        }else{
          
          Profile_ENT_T1[row, col] <<- sum(PROFILE_VI[, "SULYOZOTT_ENT_T1"], na.rm = TRUE)
      ...
      if (col == 12){
        ...
        if (row != 4){
          ...
          Profile_ENT_T1[row, col] <<- sum(subset(PROFILE_VII, eval(parse(text = filter_M065_RETEG1[row])), SULYOZOTT_ENT_T1), na.rm = TRUE)
          
        }else{
          
          Profile_ENT_T1[row, col] <<- sum(PROFILE_VII[, "SULYOZOTT_ENT_T1"], na.rm = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT_T1[profile_rows[i + ((j - 1) * 4)], c(1:8)], na.rm = TRUE))
  ...
  for(j in 1:length(ACTIVITY_PROFILE_LIST)){
    ...
    for(i in length(NUMBER_EMPL_LIST):1){
      ...
      NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
      OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT_T1[profile_rows[i + ((j - 1) * 4)], c(9:12)], na.rm = TRUE))
      cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT_T1[profile_rows[i + ((j - 1) * 4)], c(1:6, 9:10)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  for(j in 1:length(ACTIVITY_PROFILE_LIST)){
    ...
    for(i in length(NUMBER_EMPL_LIST):1){
      ...
      NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
      OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT_T1[profile_rows[i + ((j - 1) * 4)], c(7:8, 11:12)], na.rm = TRUE))
      cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT_T1[profile_rows[i + ((j - 1) * 4)], c(1, 3, 5, 7, 9)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  for(j in 1:length(ACTIVITY_PROFILE_LIST)){
    ...
    for(i in length(NUMBER_EMPL_LIST):1){
      ...
      NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
      OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT_T1[profile_rows[i + ((j - 1) * 4)], c(2, 4, 6, 8, 10:12)], na.rm = TRUE))
      cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT_T1[profile_rows[i + ((j - 1) * 4)], c(1:2)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT_T1[profile_rows[i + ((j - 1) * 4)], c(3:4)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "FUND_AUT_LOC_REG_RNDINN" & CIS_INDICATOR != "FUND_DEBT_SUCC_RNDINN" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT_T1[profile_rows[i + ((j - 1) * 4)], c(11)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_ENT_T1 <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT_T1[profile_rows[i + ((j - 1) * 4)], c(12)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_ENT_T1, TYPE_ENT_T1, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
