...
expression <- c("is.na(INN$IPR_OUT_PAT) == FALSE & INN$IPR_OUT_PAT == 1", 
                "is.na(INN$IPR_OUT_IDESG) == FALSE & INN$IPR_OUT_IDESG == 1", 
                "is.na(INN$IPR_OUT_TRDM) == FALSE & INN$IPR_OUT_TRDM == 1", 
                "is.na(INN$IPR_OUT_CPR) == FALSE & INN$IPR_OUT_CPR == 1", 
                "is.na(INN$IPR_OUT_TS) == FALSE & INN$IPR_OUT_TS == 1", 
                "is.na(INN$IPR_OUT_LIC) == FALSE & INN$IPR_OUT_LIC == 1", 
                "is.na(INN$IPR_OUT_SELL) == FALSE & INN$IPR_OUT_SELL == 1", 
                "is.na(INN$IPR_OUT_EXCH) == FALSE & INN$IPR_OUT_EXCH == 1")

expression2 <- c("IPR_OUT_PAT", 
                 "IPR_OUT_IDESG", 
                 "IPR_OUT_TRDM", 
                 "IPR_OUT_CPR", 
                 "IPR_OUT_TS", 
...
expression <- c("is.na(NINN$IPR_OUT_PAT) == FALSE & NINN$IPR_OUT_PAT == 1", 
                "is.na(NINN$IPR_OUT_IDESG) == FALSE & NINN$IPR_OUT_IDESG == 1", 
                "is.na(NINN$IPR_OUT_TRDM) == FALSE & NINN$IPR_OUT_TRDM == 1", 
                "is.na(NINN$IPR_OUT_CPR) == FALSE & NINN$IPR_OUT_CPR == 1", 
                "is.na(NINN$IPR_OUT_TS) == FALSE & NINN$IPR_OUT_TS == 1", 
                "is.na(NINN$IPR_OUT_LIC) == FALSE & NINN$IPR_OUT_LIC == 1", 
                "is.na(NINN$IPR_OUT_SELL) == FALSE & NINN$IPR_OUT_SELL == 1", 
                "is.na(NINN$IPR_OUT_EXCH) == FALSE & NINN$IPR_OUT_EXCH == 1")
...
result_T7_DT <- rbind(Aggregate_INN, Aggregate_NINN)
result_T7_DT %>% group_by(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_EMPL, INN_PF, INDICATOR, CIS_INDICATOR, UNIT_MEASURE, UNIT_MULT, DECIMALS) %>% summarise(OBS_VALUE = sum(OBS_VALUE)) -> result_T7_DT
# result_T7_DT <- result_T7_DT[, .(SUM_OBS_VALUE=sum(OBS_VALUE)), by = "DATAFLOW,FREQ,TIME_PERIOD,REF_AREA,TABLENAME,ACTIVITY,NUMBER_EMPL,INN_PF,INDICATOR,CIS_INDICATOR,UNIT_MEASURE,UNIT_MULT,DECIMALS"]
colnames(result_T7_DT)[14] <- "OBS_VALUE"

result_T7_DT_FINAL <- cbind(result_T7_DT[, 1:7], stringsAsFactors = FALSE)
result_T7_DT_FINAL$TYPE_ENT <- "_T"
result_T7_DT_FINAL <- cbind(result_T7_DT_FINAL, result_T7_DT[, c(8:10, 14, 11:13)], stringsAsFactors = FALSE)
result_T7_DT_FINAL$OBS_STATUS <- ""
result_T7_DT_FINAL$OBS_STATUS_1 <- ""
result_T7_DT_FINAL$CONF_STATUS <- ""
result_T7_DT_FINAL$COMMENT_OBS <- ""
result_T7_DT_FINAL <- as.data.frame(result_T7_DT_FINAL)
result_T7_DT_FINAL$OBS_VALUE <- as.character(result_T7_DT_FINAL$OBS_VALUE)
result_T7_DT_FINAL[, "OBS_VALUE"] <- gsub("\\.", ",", result_T7_DT_FINAL[, "OBS_VALUE"])

result_T7_DT_FINAL[result_T7_DT_FINAL$ACTIVITY == "A" | result_T7_DT_FINAL$ACTIVITY == "A01" | result_T7_DT_FINAL$ACTIVITY == "A02" | result_T7_DT_FINAL$ACTIVITY == "A03" | result_T7_DT_FINAL$ACTIVITY == "F" | result_T7_DT_FINAL$ACTIVITY == "G45" | result_T7_DT_FINAL$ACTIVITY == "G47" | result_T7_DT_FINAL$ACTIVITY == "I" | result_T7_DT_FINAL$ACTIVITY == "L" | result_T7_DT_FINAL$ACTIVITY == "M69" | result_T7_DT_FINAL$ACTIVITY == "M70" | result_T7_DT_FINAL$ACTIVITY == "M74" | result_T7_DT_FINAL$ACTIVITY == "M75" | result_T7_DT_FINAL$ACTIVITY == "N" | result_T7_DT_FINAL$ACTIVITY == "N77" | result_T7_DT_FINAL$ACTIVITY == "N78" | result_T7_DT_FINAL$ACTIVITY == "N79" | result_T7_DT_FINAL$ACTIVITY == "N80" | result_T7_DT_FINAL$ACTIVITY == "N81" | result_T7_DT_FINAL$ACTIVITY == "N82", "OBS_VALUE"] <- ""
result_T7_DT_FINAL <- subset(result_T7_DT_FINAL, ACTIVITY != "GTN" | (ACTIVITY == "GTN" & (NUMBER_EMPL == "_T")))
# result_T7_DT_FINAL <- subset(result_T7_DT_FINAL, ACTIVITY != "G" & ACTIVITY != "M")
...
set_ENT_Profile("as.numeric(IPR_OUT_EXCH)", "T07", T7_SDMX_FINAL_RESULT)
set_ENT_Profile("as.numeric(IPR_OUT_IDESG)", "T07", T7_SDMX_FINAL_RESULT)
set_ENT_Profile("as.numeric(IPR_OUT_LIC)", "T07", T7_SDMX_FINAL_RESULT)
set_ENT_Profile("as.numeric(IPR_OUT_PAT)", "T07", T7_SDMX_FINAL_RESULT)
set_ENT_Profile("as.numeric(IPR_OUT_SELL)", "T07", T7_SDMX_FINAL_RESULT)
set_ENT_Profile("as.numeric(IPR_OUT_TRDM)", "T07", T7_SDMX_FINAL_RESULT)
set_ENT_Profile("as.numeric(IPR_OUT_TS)", "T07", T7_SDMX_FINAL_RESULT)