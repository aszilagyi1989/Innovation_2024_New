...
expression <- c("is.na(INN$REAS_NMINN_RESC) == FALSE & INN$REAS_NMINN_RESC == 1",
                "is.na(INN$REAS_NMINN_OTH) == FALSE & INN$REAS_NMINN_OTH == 1",
                "is.na(INN$REAS_NMINN_NNEED) == FALSE & INN$REAS_NMINN_NNEED == 1",
                "INN$M092 %in% REAS_NMINN_RESC_OTH$M092",
                "is.na(INN$REAS_NINN_RESC) == FALSE & INN$REAS_NINN_RESC == 1",
                "is.na(INN$REAS_NINN_OTH) == FALSE & INN$REAS_NINN_OTH == 1",
                "is.na(INN$REAS_NINN_NNEED) == FALSE & INN$REAS_NINN_NNEED == 1",
                "INN$M092 %in% REAS_NINN_RESC_OTH$M092")

expression2 <- c("REAS_NMINN_RESC", 
                 "REAS_NMINN_OTH",
                 "REAS_NMINN_NNEED",
                 "REAS_NMINN_RESC_OTH",
                 "REAS_NINN_RESC",
...
expression <- c("is.na(NINN$REAS_NMINN_RESC) == FALSE & NINN$REAS_NMINN_RESC == 1",
                "is.na(NINN$REAS_NMINN_OTH) == FALSE & NINN$REAS_NMINN_OTH == 1",
                "is.na(NINN$REAS_NMINN_NNEED) == FALSE & NINN$REAS_NMINN_NNEED == 1",
                "NINN$M092 %in% REAS_NMINN_RESC_OTH$M092",
                "is.na(NINN$REAS_NINN_RESC) == FALSE & NINN$REAS_NINN_RESC == 1",
                "is.na(NINN$REAS_NINN_OTH) == FALSE & NINN$REAS_NINN_OTH == 1",
                "is.na(NINN$REAS_NINN_NNEED) == FALSE & NINN$REAS_NINN_NNEED == 1",
                "NINN$M092 %in% REAS_NINN_RESC_OTH$M092")
...
set_ENT_Profile("REAS_NINN_NNEED", "T32", T32_SDMX_FINAL_RESULT)
set_ENT_Profile("REAS_NINN_OTH", "T32", T32_SDMX_FINAL_RESULT)
set_ENT_Profile("REAS_NINN_RESC", "T32", T32_SDMX_FINAL_RESULT)
set_ENT_Profile("REAS_NINN_RESC_OTH", "T32", T32_SDMX_FINAL_RESULT)
set_ENT_Profile("REAS_NMINN_NNEED", "T32", T32_SDMX_FINAL_RESULT)
set_ENT_Profile("REAS_NMINN_OTH", "T32", T32_SDMX_FINAL_RESULT)
set_ENT_Profile("REAS_NMINN_RESC", "T32", T32_SDMX_FINAL_RESULT)
set_ENT_Profile("REAS_NMINN_RESC_OTH", "T32", T32_SDMX_FINAL_RESULT)