...
expression <- c("is.na(INN$FUND_EQUIT_SUCC) == FALSE & INN$FUND_EQUIT_SUCC == 1", 
                ...
                "is.na(INN$FUND_EU_HP) == FALSE & INN$FUND_EU_HP == 1", 
                "is.na(INN$FUND_EU_HP_RNDINN) == FALSE & INN$FUND_EU_HP_RNDINN == 1", 
...
expression <- c("is.na(NINN$FUND_EQUIT_SUCC) == FALSE & NINN$FUND_EQUIT_SUCC == 1", 
                ...
                "is.na(NINN$FUND_EU_HP) == FALSE & NINN$FUND_EU_HP == 1", 
                "is.na(NINN$FUND_EU_HP_RNDINN) == FALSE & NINN$FUND_EU_HP_RNDINN == 1", 
...
result_T16_DT %>% group_by(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_EMPL, INN_PF, INDICATOR, CIS_INDICATOR, UNIT_MEASURE, UNIT_MULT, DECIMALS) %>% summarise(OBS_VALUE = sum(OBS_VALUE)) -> result_T16_DT
...
result_T16_DT_FINAL <- subset(result_T16_DT_FINAL, (TYPE_ENT == "INN" & (CIS_INDICATOR == "FUND_EQUIT_SUCC_RNDINN" | CIS_INDICATOR == "FUND_DEBT_SUCC_RNDINN" | CIS_INDICATOR == "FUND_AUT_LOC_REG_RNDINN" | CIS_INDICATOR == "FUND_GOV_CTL_RNDINN" | CIS_INDICATOR == "FUND_EU_HP_RNDINN" | CIS_INDICATOR == "FUND_EU_OTH_RNDINN" | CIS_INDICATOR == "FUND_FOR_RNDINN")) | (CIS_INDICATOR == "FUND_EQUIT_SUCC" | CIS_INDICATOR == "FUND_EQUIT_NSUCC" | CIS_INDICATOR == "FUND_DEBT_SUCC" | CIS_INDICATOR == "FUND_DEBT_NSUCC" | CIS_INDICATOR == "FUND_AUT_LOC_REG" | CIS_INDICATOR == "FUND_GOV_CTL" | CIS_INDICATOR == "FUND_EU_HP" | CIS_INDICATOR == "FUND_EU_OTH" | CIS_INDICATOR == "FUND_SOURCE"))
...
result_T16_DT_FINAL[result_T16_DT_FINAL$ACTIVITY == "G" | result_T16_DT_FINAL$ACTIVITY == "M", "OBS_VALUE"] <- ""
...
set_ENT_Profile("as.numeric(FUND_EU_HP)", "T16", T16_SDMX_FINAL_RESULT)
set_ENT_Profile("as.numeric(FUND_EU_HP_RNDINN)", "T16", T16_SDMX_FINAL_RESULT)
