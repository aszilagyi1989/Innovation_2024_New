set_ENT_Profile <- function(column_name, tablename_Profile, save_filename){
    ...
    for(row in 1:length(filter_M065_RETEG1)){
      ...
      if (col == 1){
        ...
        if (row != 4){
          ...
          Profile_ENT[row, col] <<- sum(PROFILE_I_A[, "SULYOZOTT_ENT"], na.rm = TRUE)
      ...
      if (col == 2){
        ...
        if (row != 4){
          ...
          Profile_ENT[row, col] <<- sum(PROFILE_I_B[, "SULYOZOTT_ENT"], na.rm = TRUE)
      ...
      if (col == 3){
        ...
        if (row != 4){
          ...
          Profile_ENT[row, col] <<- sum(PROFILE_II_A[, "SULYOZOTT_ENT"], na.rm = TRUE)
      ...
      if (col == 4){
        ...
        if (row != 4){
          ...
          Profile_ENT[row, col] <<- sum(PROFILE_II_B[, "SULYOZOTT_ENT"], na.rm = TRUE)
      ...
      if (col == 5){
        ...
        if (row != 4){
          ...
          Profile_ENT[row, col] <<- sum(PROFILE_III_A[, "SULYOZOTT_ENT"], na.rm = TRUE)
      ...
      if (col == 6){
        ...
        if (row != 4){
          ...
          Profile_ENT[row, col] <<- sum(PROFILE_III_B[, "SULYOZOTT_ENT"], na.rm = TRUE)
      ...
      if (col == 7){
        ...
        if (row != 4){
          ...
          Profile_ENT[row, col] <<- sum(PROFILE_IV_A[, "SULYOZOTT_ENT"], na.rm = TRUE)
      ...
      if (col == 8){
        ...
        if (row != 4){
          ...
          Profile_ENT[row, col] <<- sum(PROFILE_IV_B[, "SULYOZOTT_ENT"], na.rm = TRUE)
      ...
      if (col == 9){
        ...
        if (row != 4){
          ...
          Profile_ENT[row, col] <<- sum(PROFILE_V_A[, "SULYOZOTT_ENT"], na.rm = TRUE)
      ...
      if (col == 10){
        ...
        if (row != 4){
          ...
          Profile_ENT[row, col] <<- sum(PROFILE_V_B[, "SULYOZOTT_ENT"], na.rm = TRUE)
      ...
      if (col == 11){
        ...
        if (row != 4){
          ...
          Profile_ENT[row, col] <<- sum(PROFILE_VI[, "SULYOZOTT_ENT"], na.rm = TRUE)
      ...
      if (col == 12){
        ...
        if (row != 4){
          ...
          Profile_ENT[row, col] <<- sum(PROFILE_VII[, "SULYOZOTT_ENT"], na.rm = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT[profile_rows[i + ((j - 1) * 4)], c(1:8)], na.rm = TRUE))
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_EMPL <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT[profile_rows[i + ((j - 1) * 4)], c(1:6, 9:10)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_EMPL, TYPE_ENT, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  for(j in 1:length(ACTIVITY_PROFILE_LIST)){
    ...
    for(i in length(NUMBER_EMPL_LIST):1){
      ...
      NUMBER_EMPL <- NUMBER_EMPL_LIST[i]
      OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT[profile_rows[i + ((j - 1) * 4)], c(7:8, 11:12)], na.rm = TRUE))
      cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_EMPL, TYPE_ENT, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_EMPL <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT[profile_rows[i + ((j - 1) * 4)], c(1, 3, 5, 7, 9)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_EMPL, TYPE_ENT, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  for(j in 1:length(ACTIVITY_PROFILE_LIST)){
    ...
    for(i in length(NUMBER_EMPL_LIST):1){
      ...
      NUMBER_EMPL <- NUMBER_EMPL_LIST[i]
      OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT[profile_rows[i + ((j - 1) * 4)], c(2, 4, 6, 8, 10:12)], na.rm = TRUE))
      cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_EMPL, TYPE_ENT, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_EMPL <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT[profile_rows[i + ((j - 1) * 4)], c(1:2)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_EMPL, TYPE_ENT, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "REAS_NINN_NNEED" & CIS_INDICATOR != "REAS_NINN_OTH" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_EMPL <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT[profile_rows[i + ((j - 1) * 4)], c(3:4)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_EMPL, TYPE_ENT, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
  ...
  if (CIS_INDICATOR != "FUND_AUT_LOC_REG_RNDINN" & CIS_INDICATOR != "FUND_DEBT_SUCC_RNDINN" 
      & CIS_INDICATOR != "FUND_EQUIT_SUCC_RNDINN" & CIS_INDICATOR != "FUND_EU_HP_RNDINN" 
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_EMPL <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT[profile_rows[i + ((j - 1) * 4)], c(11)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_EMPL, TYPE_ENT, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
    ...
    for(j in 1:length(ACTIVITY_PROFILE_LIST)){
      ...
      for(i in length(NUMBER_EMPL_LIST):1){
        ...
        NUMBER_EMPL <- NUMBER_EMPL_LIST[i]
        OBS_VALUE <-  gsub("\\.", ",", sum(Profile_ENT[profile_rows[i + ((j - 1) * 4)], c(12)], na.rm = TRUE))
        cat(paste(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_EMPL, TYPE_ENT, INN_PF, INDICATOR, CIS_INDICATOR,	OBS_VALUE, UNIT_MEASURE, UNIT_MULT, DECIMALS, sep = ";"), sep = "\n", file = save_filename, append = TRUE)
