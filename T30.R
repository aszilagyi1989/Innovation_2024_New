...
set_ENT_Profile("ECO_NSG", "T30", T30_SDMX_FINAL_RESULT)
set_ENT_Profile("ECO_WENT_SG", "T30", T30_SDMX_FINAL_RESULT)
set_ENT_Profile("ECO_WENT_NSG", "T30", T30_SDMX_FINAL_RESULT)
...
set_ENT_Profile("ECO_DUCO_SG", "T30", T30_SDMX_FINAL_RESULT)
set_ENT_Profile("ECO_DUCO_NSG", "T30", T30_SDMX_FINAL_RESULT)
