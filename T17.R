...
colnames(result_T17_DT)[14] <- "OBS_VALUE"
...
result_T17_DT_FINAL <- subset(result_T17_DT_FINAL, CIS_INDICATOR == "TAX_CRED_OTH")
...
Aggregate_NINN <- subset(Aggregate_NINN, CIS_INDICATOR == "TAX_CRED_OTH")
...
result_T17_DT_FINAL[result_T17_DT_FINAL$ACTIVITY == "G" | result_T17_DT_FINAL$ACTIVITY == "M", "OBS_VALUE"] <- ""
