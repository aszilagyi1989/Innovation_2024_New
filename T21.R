...
expression <- c("is.na(INN$EMPUD_PC0) == FALSE & INN$EMPUD_PC0 == 1", 
                "is.na(INN$EMPUD_PC1T4) == FALSE & INN$EMPUD_PC1T4 == 1", 
                "is.na(INN$EMPUD_PC5T9) == FALSE & INN$EMPUD_PC5T9 == 1", 
                "is.na(INN$EMPUD_PC10T24) == FALSE & INN$EMPUD_PC10T24 == 1", 
                "is.na(INN$EMPUD_PC25T49) == FALSE & INN$EMPUD_PC25T49 == 1", 
                "is.na(INN$EMPUD_PC50T74) == FALSE & INN$EMPUD_PC50T74 == 1", 
                "is.na(INN$EMPUD_PC_GE75) == FALSE & INN$EMPUD_PC_GE75 == 1")

expression2 <- c("EMPUD_PC0", 
                 "EMPUD_PC1T4", 
                 "EMPUD_PC5T9", 
                 "EMPUD_PC10T24", 
                 "EMPUD_PC25T49", 
...
expression <- c("is.na(NINN$EMPUD_PC0) == FALSE & NINN$EMPUD_PC0 == 1", 
                "is.na(NINN$EMPUD_PC1T4) == FALSE & NINN$EMPUD_PC1T4 == 1", 
                "is.na(NINN$EMPUD_PC5T9) == FALSE & NINN$EMPUD_PC5T9 == 1", 
                "is.na(NINN$EMPUD_PC10T24) == FALSE & NINN$EMPUD_PC10T24 == 1", 
                "is.na(NINN$EMPUD_PC25T49) == FALSE & NINN$EMPUD_PC25T49 == 1", 
                "is.na(NINN$EMPUD_PC50T74) == FALSE & NINN$EMPUD_PC50T74 == 1", 
                "is.na(NINN$EMPUD_PC_GE75) == FALSE & NINN$EMPUD_PC_GE75 == 1")
...
result_T21_DT <- rbind(Aggregate_INN, Aggregate_NINN)
result_T21_DT %>% group_by(DATAFLOW, FREQ, TIME_PERIOD, REF_AREA, TABLENAME, ACTIVITY, NUMBER_EMPL, INN_PF, INDICATOR, CIS_INDICATOR, UNIT_MEASURE, UNIT_MULT, DECIMALS) %>% summarise(OBS_VALUE = sum(OBS_VALUE)) -> result_T21_DT
# result_T21_DT <- result_T21_DT[, .(SUM_OBS_VALUE=sum(OBS_VALUE)), by = "DATAFLOW,FREQ,TIME_PERIOD,REF_AREA,TABLENAME,ACTIVITY,NUMBER_EMPL,INN_PF,INDICATOR,CIS_INDICATOR,UNIT_MEASURE,UNIT_MULT,DECIMALS"]
colnames(result_T21_DT)[14] <- "OBS_VALUE"

result_T21_DT_FINAL <- cbind(result_T21_DT[, 1:7], stringsAsFactors = FALSE)
result_T21_DT_FINAL$TYPE_ENT <- "_T"
result_T21_DT_FINAL <- cbind(result_T21_DT_FINAL, result_T21_DT[, c(8:10, 14, 11:13)], stringsAsFactors = FALSE)
result_T21_DT_FINAL$OBS_STATUS <- ""
result_T21_DT_FINAL$OBS_STATUS_1 <- ""
result_T21_DT_FINAL$CONF_STATUS <- ""
result_T21_DT_FINAL$COMMENT_OBS <- ""
result_T21_DT_FINAL <- as.data.frame(result_T21_DT_FINAL)
result_T21_DT_FINAL$OBS_VALUE <- as.character(result_T21_DT_FINAL$OBS_VALUE)
result_T21_DT_FINAL[, "OBS_VALUE"] <- gsub("\\.", ",", result_T21_DT_FINAL[, "OBS_VALUE"])

result_T21_DT_FINAL[result_T21_DT_FINAL$ACTIVITY == "A" | result_T21_DT_FINAL$ACTIVITY == "A01" | result_T21_DT_FINAL$ACTIVITY == "A02" | result_T21_DT_FINAL$ACTIVITY == "A03" | result_T21_DT_FINAL$ACTIVITY == "F" | result_T21_DT_FINAL$ACTIVITY == "G45" | result_T21_DT_FINAL$ACTIVITY == "G47" | result_T21_DT_FINAL$ACTIVITY == "I" | result_T21_DT_FINAL$ACTIVITY == "L" | result_T21_DT_FINAL$ACTIVITY == "M69" | result_T21_DT_FINAL$ACTIVITY == "M70" | result_T21_DT_FINAL$ACTIVITY == "M74" | result_T21_DT_FINAL$ACTIVITY == "M75" | result_T21_DT_FINAL$ACTIVITY == "N" | result_T21_DT_FINAL$ACTIVITY == "N77" | result_T21_DT_FINAL$ACTIVITY == "N78" | result_T21_DT_FINAL$ACTIVITY == "N79" | result_T21_DT_FINAL$ACTIVITY == "N80" | result_T21_DT_FINAL$ACTIVITY == "N81" | result_T21_DT_FINAL$ACTIVITY == "N82", "OBS_VALUE"] <- ""
result_T21_DT_FINAL <- subset(result_T21_DT_FINAL, ACTIVITY != "GTN" | (ACTIVITY == "GTN" & (NUMBER_EMPL == "_T")))
# result_T21_DT_FINAL <- subset(result_T21_DT_FINAL, ACTIVITY != "G" & ACTIVITY != "M")

result_T21_DT_FINAL <- subset(result_T21_DT_FINAL, TYPE_ENT == "_T")
...
result_T21_DT_FINAL[result_T21_DT_FINAL$ACTIVITY == "G" | result_T21_DT_FINAL$ACTIVITY == "M", "OBS_VALUE"] <- ""
...
write.table(rbind(result_T21_DT_FINAL, Aggregate_INN, Aggregate_NINN), T21_SDMX_FINAL_RESULT, sep = ";", quote = FALSE, row.names = FALSE, append = FALSE)

set_ENT_Profile("EMPUD_PC_GE75", "T21", T21_SDMX_FINAL_RESULT)
set_ENT_Profile("EMPUD_PC0", "T21", T21_SDMX_FINAL_RESULT)
set_ENT_Profile("EMPUD_PC10T24", "T21", T21_SDMX_FINAL_RESULT)
set_ENT_Profile("EMPUD_PC1T4", "T21", T21_SDMX_FINAL_RESULT)
set_ENT_Profile("EMPUD_PC25T49", "T21", T21_SDMX_FINAL_RESULT)
set_ENT_Profile("EMPUD_PC50T74", "T21", T21_SDMX_FINAL_RESULT)
set_ENT_Profile("EMPUD_PC5T9", "T21", T21_SDMX_FINAL_RESULT)